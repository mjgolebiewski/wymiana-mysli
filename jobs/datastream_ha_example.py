...
def main():
    ...
    kafka_properties = {
        "bootstrap.servers": "http://192.168.5.205:9092",
    ...
    kafka_consumer = FlinkKafkaConsumer(
        topics="home_assistant_vpm",  # homeassistant.sensor.rasppid.28-00000beda6a6.temperature
    ...
    result_stream = stream_source.filter(
        ...
        == "sensor.battery_sim_lg_chem_current_discharging_rate"
        and x["state"] == "0.0"
    )

    # Define the kafka sink properties
    # kafka_properties_sink = {
